...
spells.each do |spell|
    ...
    #use JSON.parse to conver this string to a Ruby hash:
    ...
    Spell.create(
        ...
        description: spell_hash["desc"][0] #spell_hash["desc"] returns an array, so we need to access the first index to get just a string.
    )
end
